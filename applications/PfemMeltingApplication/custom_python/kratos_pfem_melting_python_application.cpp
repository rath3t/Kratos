...
PYBIND11_MODULE(KratosPfemMeltingApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CARBONIZATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DECOMPOSITION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DECOMPOSITION_THRESHOLD)
