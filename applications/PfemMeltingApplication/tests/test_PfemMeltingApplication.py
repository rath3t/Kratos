...
def AssembleTestSuites():
    ...
    # SMALL TESTS
    small_suite = SmallTests.SetTestSuite(suites) # These tests are executed by the continuous integration tool

    # NIGHTLY TESTS
    night_suite = NightTests.SetTestSuite(suites) # These tests are executed in the nightly build
