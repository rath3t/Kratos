...
void KratosStructuralMechanicsApplication::Register() {
    ...
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CENTER_OF_GRAVITY);
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(RELATIVE_DISPLACEMENT);
    KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(RELATIVE_ROTATION);
